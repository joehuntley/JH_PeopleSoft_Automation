...
Public Function PeopleSoft_PurchaseOrder_ProcessReceipt(ByRef session As PeopleSoft_Session, ByRef rcpt As PeopleSoft_Receipt) As Boolean
    ...
    Debug.Print "Receipt ID Check #1 (before popups): ", rcpt.RECEIPT_ID
    ...
    If popupCheckResult.HasPopup = False Or Not popupCheckResult.PopupText Like "*Have these receipt quantities been checked for accuracy*" Then
        rcpt.HasGlobalError = True
    ...
    If rcpt.RECEIPT_ID <> "" Then
        ...
        Do
            ...
            Debug.Print "Popup Received after Receipt: " & popupCheckResult.PopupText
    ...
    ' Check for receipt ID.
    rcpt.RECEIPT_ID = driver.findElementById("RECV_HDR_RECEIVER_ID").Text
    Debug.Print "Receipt ID Check #3: ", rcpt.RECEIPT_ID
